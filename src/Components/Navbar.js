...
const Navbar = () => {
    ...
    return (
        <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
            ...
            {/* hamburger */}
            <div
                onClick={handleClick} className='md:hidden z-10 cursor-pointer'
            >
                {/* z to show hamburger over other */}
                {/* three lines */}
            ...
            {/* social icons */}
            {/* can only show in large screens by this => 
                hidden lg:flex fixed flex-col top-[35%] left-0 
            */}

            {/* not hidden => flex fixed flex-col top-[35%] left-0 */}
